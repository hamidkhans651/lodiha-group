...
const Footer = () => {
  return (
    <footer>
      <div className="bg-white  mb-2 text-gray-400">
        <div className="container px-4 mx-auto  ">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-1/5">
              {/* <div className=" flex text-xl">
                {['lodhia-gypsum-logo'].map((path) => {
                  return (
                    <div key={path}>
                      <Image src={`/${path}.png`}
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Our Address</h2>
              </div>
              <ul className="leading-8">
                <li><a href="#" className="hover:text-blue-400">Suite# 105, Business & Finance Centre</a></li>
                <li><a href="#" className="hover:text-blue-400">I.I. Chundrigar Road, Karachi-Pakistan.</a></li>
                <li><a href="#" className="hover:text-blue-400">Tel: +92-21-3243 4308,</a></li>
                <li><a href="#" className="hover:text-blue-400">3241 3832, 3246 7890</a></li>
                <li><a href="#" className="hover:text-blue-400">Email: info@arishdrywall.com</a></li>
              </ul>
            </div>
      ...
      <div className="bg-[#3E3E40]  text-gray-100">
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
              {/* © 2015
              <script>new Date().getFullYear()  2024 && document.write("- " + new Date().getFullYear())</script>- 2022
              Lodhia Gypsum Industries (PVT.) Ltd. - All Rights Reserved */}
            </div>
